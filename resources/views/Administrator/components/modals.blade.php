    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="row g-3 mt-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="dropdown">
                                <button class="form-control text-start dropdown-toggle" type="button" id="roleDropdown"
                                ...
                                <ul class="dropdown-menu shadow rounded-3 w-100" aria-labelledby="roleDropdown">
                                    <li><a class="dropdown-item d-flex align-items-center" href="#"><i
                                                class="bi bi-person me-2"></i> Student</a></li>
                                    <li><a class="dropdown-item d-flex align-items-center" href="#"><i
                                                class="bi bi-briefcase me-2"></i> Faculty</a></li>
                                    <li><a class="dropdown-item d-flex align-items-center" href="#"><i
                                                class="bi bi-people me-2"></i> Staff</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
