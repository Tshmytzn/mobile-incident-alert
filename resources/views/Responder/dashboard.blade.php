                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div id="assigned_incidents" class="text-secondary">
                                                        @php
                                                        $responderId = session('responder_id');
                                                    
                                                        // Count the incidents assigned to the logged-in responder
                                                        $assigned = \App\Models\Incidents::where('responder_id', $responderId)
                                                                                        ->count();
                                                    @endphp
                                                    
                                                    @if ($assigned > 0)
                                                        {{ $assigned }} Incident/s Assigned
                                                    @else
